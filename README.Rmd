...
In this example the world map SVG has CSS classes corresponding to the countries.
The `.Canada` and `.Australia` objects in the SVG have their fill colour set to 
static values which match the boxplot colours.

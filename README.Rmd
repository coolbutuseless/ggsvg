...
* `css(selector, property = value)` is a helper function for aesthetic mapping
  to CSS Selector targets within SVGs
...
* **`css("circle#top", fill='#aaaaaa")`**
    ...
    * Set a constant value of `#aaaaaa` for the SVG `fill` property for these targetted
      elements.
